...
class ProductVariantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $variantMap = [
            'Vịt nguyên con làm sạch' => [
                ['name' => '2.0 kg', 'size' => '2.0 kg'],
                ['name' => '2.1 kg', 'size' => '2.1 kg'],
                ['name' => '2.2 kg', 'size' => '2.2 kg'],
                ['name' => '2.3 kg', 'size' => '2.3 kg'],
                ['name' => '2.4 kg', 'size' => '2.4 kg'],
                ['name' => '2.5 kg', 'size' => '2.5 kg'],
                ['name' => '2.6 kg', 'size' => '2.6 kg'],
                ['name' => '2.7 kg', 'size' => '2.7 kg'],
                ['name' => '2.8 kg', 'size' => '2.8 kg'],
                ['name' => '2.9 kg', 'size' => '2.9 kg'],
                ['name' => '3.0 kg', 'size' => '3.0 kg'],
                ['name' => 'Lớn hơn 3.0 kg', 'size' => '> 3.0 kg'],
            ],
            'Vịt loại bầm' => [
