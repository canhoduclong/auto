    ...
    private function mobileMenuByLayout(string $layout, bool $canManageShipper = false, array $roleNames = []): array
    {
        ...
        if ($layout === 'warehouse') {
            return [
                ...
                ['group' => 'Xử lý chính', 'key' => 'incoming_transfers', 'label' => 'Tiếp nhận', 'route' => '/warehouse/transfers/incoming', 'api' => '/screens/warehouse/incoming_transfers', 'icon' => 'move_to_inbox'],
