...
class Order extends Model
{
    ...
    protected $fillable = [
        ...
        'truck_station_phone', 'truck_receive_time', 'truck_label_print_count', 'truck_label_printed_at', 'truck_label_printed_by',
    ...
    protected $casts = [
        ...
        'truck_label_print_count' => 'integer',
        'truck_label_printed_at' => 'datetime',
