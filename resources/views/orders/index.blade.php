                                ...
                                <td>
                                    <div class="d-flex flex-wrap gap-1">
                                        ...
                                        @if(auth()->user()?->isAdmin() && $order->status === \App\Models\Order::STATUS_OVERDUE_DELIVERY)
                                            <form action="{{ route('orders.resume-overdue-delivery', $order) }}" method="POST" class="d-inline"
                                        ...
                                        @if(auth()->user()?->isAdmin())
                                            <form action="{{ route('orders.admin-delete', $order) }}" method="POST" class="d-inline"
