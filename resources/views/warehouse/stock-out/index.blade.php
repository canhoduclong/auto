...
(function () {
    ...
    document.getElementById('itemsContainerOut').addEventListener('change', function (e) {
    ...
    document.querySelectorAll('#itemsContainerOut [data-item-row]').forEach(syncUnitLabel);
})();
</script>
@endpush
@endsection
