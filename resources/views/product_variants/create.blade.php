...
<div class="container">
    ...
    <form action="{{ route('product-variants.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="kg" class="form-control" value="{{ old('kg', 1) }}" min="0.01" step="0.01" required>
        </div>
        <div class="mb-3 form-check">
            <input type="checkbox" class="form-check-input" id="is_priced_by_kg" name="is_priced_by_kg" value="1" {{ old('is_priced_by_kg', 1) ? 'checked' : '' }}>
