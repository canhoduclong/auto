...
@section('subtitle', 'Điều hành giá sản phẩm')
...
<div class="content">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('ceo.price-management.index') }}" class="row g-2">
                <div class="col-md-5">
                    <input
                        type="text"
                        name="name"
                ...
                <div class="col-auto">
                    <a href="{{ route('ceo.price-management.index') }}" class="btn btn-light">Đặt lại</a>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <tbody>
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('ceo.price-management.show', $product) }}" class="btn btn-sm btn-primary">
                                        Cập nhật giá
                                    </a>
                                </td>
                            </tr>
