                                        ...
                                        <tbody>
                                            @foreach(session('cart') as $id => $details)
                                                ...
                                                <tr data-id="{{ $id }}">
                                                    ...
                                                    <td>
                                                        <div class="cart-item-weight text-muted small">{{ $isPricedByKg ? $formatKg($unitWeight) : number_format($unitWeight, 3, ',', '.') . ' ' . ($details['unit_label'] ?? 'Cái') }}</div>
                                                    </td>
                                        ...
                                        <div class="cart-mobile-item" data-id="{{ $id }}">
                                            <div class="cart-mobile-top">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="cart-item-name">{{ $details['name'] }}</div>
                                                    <div class="cart-item-sku">SKU: {{ $details['sku'] }}</div>
                                                    <div class="cart-item-weight text-muted small" data-weight="{{ $unitWeight }}">{{ $isPricedByKg ? $formatKg($unitWeight) : number_format((float) $unitWeight, 3, ',', '.') . ' ' . ($details['unit_label'] ?? 'Cái') }} | {{ $isPricedByKg ? 'Theo kg' : 'Theo đơn vị' }}</div>
                                                </div>
