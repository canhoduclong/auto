...
Route::middleware(['auth', 'assigned'])->group(function () {
    ...
    Route::prefix('admin/warehouse-dispatch-slips')->name('admin.warehouse-dispatch-slips.')->middleware('role:admin')->group(function () {
        ...
        Route::post('/{dispatchSlip}/mismatched-orders/remove', [\App\Http\Controllers\Warehouse\WarehouseDispatchSlipController::class, 'removeMismatchedOrders'])->name('mismatched-orders.remove');
...
Route::middleware(['auth', 'role:sale,leader,leader_sale,sale_manager,manager,manager_sale,director,admin'])->group(function () {
    ...
    Route::post('/my-order-drafts/customers/{customer}/pin', [\App\Http\Controllers\Admin\TextOrderImportController::class, 'updateCustomerPin'])->name('pages.my_order_drafts.customers.pin')->middleware('role:sale,leader,leader_sale,sale_manager,manager,manager_sale,admin');
